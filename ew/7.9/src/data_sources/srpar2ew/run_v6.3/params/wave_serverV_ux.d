...
TankStructFile  /usr/local/earthworm/v6.3/run_symres/data/p1000-1.str

# I open many files, one tracedata file for each SCN channel to serve
...
#
#           SCN    Record       Logo                  File Size   Index Size       File Name	    New       
#          names   size  (TYPE_TRACEBUF only)         (megabytes) (max breaks)     (full path)      Tank      

Tank    CH00 SHZ SR 480   INST_UNKNOWN    MOD_WILDCARD       1         10000         /usr/local/earthworm/v6.3/run_symres/data/ch00.tnk
Tank    CH01 SHE SR 480   INST_UNKNOWN    MOD_WILDCARD       1         10000         /usr/local/earthworm/v6.3/run_symres/data/ch01.tnk
Tank    CH02 SHN SR 480   INST_UNKNOWN    MOD_WILDCARD       1         10000         /usr/local/earthworm/v6.3/run_symres/data/ch02.tnk
Tank    CH03 SHZ SR 480   INST_UNKNOWN    MOD_WILDCARD       1         10000         /usr/local/earthworm/v6.3/run_symres/data/ch03.tnk
Tank    MARK GPS SR 480   INST_UNKNOWN    MOD_WILDCARD       1         10000         /usr/local/earthworm/v6.3/run_symres/data/mark.tnk
...
TankStructFile2  /usr/local/earthworm/v6.3/run_symres/data/p1000-2.str
...
#MaxMsgSize: Optional command to tell wave_server about TRACEBUF messages
