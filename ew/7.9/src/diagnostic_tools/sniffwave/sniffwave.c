...
/*
 *
 *    $Id: sniffwave.c 6470 2016-02-10 20:18:14Z paulf $
 *
 *    Revision history:
 *     $Log$
...
#define NLOGO 5
#define VERSION "2016-02-10 2.5.4"
...
int main( int argc, char **argv )
{
  ...
  *****************************/
  if ( argc < 2 || argc > 6 )
  {
     ...
     fprintf(stderr,"Usage: %s <ring name> [sta] [comp] [net] [loc] [y/n/s/time] [v]\n", argv[0]);
     fprintf(stderr, " Note: All parameters are positional, and all but first are optional.\n");
     fprintf(stderr, " Appending the optional 'v' or 'verbose' argument causes module,\n");
     fprintf(stderr, " installation and type names to be printed in addition to usual ID numbers.\n");
     fprintf(stderr, " The <y/n/s> flag is a data flag or 'time in seconds'. If 'y' is specified\n");
